...
const PortfolioSection = () => {
  ...
  return (
    <section className="min-h-screen bg-white dark:bg-[#08080a] text-slate-900 dark:text-white lg:py-20 md:py-12 py-5 px-4 md:px-12 transition-colors duration-300">
