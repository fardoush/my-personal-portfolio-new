...
const services = [
  {
    ...
    desc: "Building high-performance, responsive websites using React, Next.js, and modern CSS frameworks.",
    icon: <FaCode className="text-indigo-500" size={30} />,
    tag: "Frontend"
  },
  {
    title: "UI/UX Design",
    desc: "Creating intuitive and aesthetically pleasing user interfaces with a focus on user experience.",
    icon: <FaPaintBrush className="text-purple-500" size={30} />,
    tag: "Design"
  },
  {
    title: "Backend Solutions",
    desc: "Developing scalable server-side applications, database management, and secure API integrations.",
    icon: <FaServer className="text-emerald-500" size={30} />,
    tag: "Systems"
  },
  {
    title: "App Optimization",
    desc: "Improving website speed, SEO, and accessibility to ensure the best performance for all users.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative p-8 rounded-[2.5rem] bg-slate-50 dark:bg-[#121217] border border-slate-200 dark:border-slate-800 hover:border-indigo-500/50 transition-all duration-500"
            >
