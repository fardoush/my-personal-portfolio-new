          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              <a target="_blank"
                ...
                className="w-12 h-12 flex items-center justify-center rounded-2xl bg-slate-50 dark:bg-[#121217] border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-white hover:bg-indigo-500 hover:border-indigo-500 transition-all duration-300"
              >
                {social.icon}
              </a>
            ))}
