...
const Skills = ({ name, icon, level, color, shadow }) => {
  return (
    <div className={`group relative p-8 rounded-[2.5rem] flex flex-col items-center justify-center gap-5 transition-all duration-500 hover:-translate-y-3 border border-gray-100 dark:border-white/5 bg-white/80 dark:bg-[#111114] shadow-sm ${shadow}`}>
      ...
      {/* Icon with Glow */}
      <div className={`text-6xl ${color} transition-all duration-500 group-hover:scale-110 relative z-10`}>
      ...
      <div className="text-center z-10">
        ...
        <div className={`mt-3 text-[9px] font-bold px-4 py-1 rounded-full border transition-all duration-500 ${
          level === 'Learning' 
