...
const PortfolioCard = ({ project, onClick }) => {
    ...
    return (
        <div className="group bg-slate-50 dark:bg-[#121217] rounded-[2rem] overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-indigo-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10">
